...
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE BIGINT NOT NULL, ACTIVO VARCHAR(255), NOTA_MEDIA_PROVISIONAL FLOAT, ID BIGINT, TE_CÓDIGO BIGINT, PRIMARY KEY (NUM_EXPEDIENTE))
...
ALTER TABLE EXPEDIENTE ADD CONSTRAINT FK_EXPEDIENTE_ID FOREIGN KEY (ID) REFERENCES USUARIO (ID)

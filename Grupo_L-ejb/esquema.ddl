...
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR BIGINT, CURSO BIGINT, INGLES VARCHAR, LETRA VARCHAR, PLAZAS BIGINT, TURNO_MANIANA_TARDE VARCHAR, VISIBLE BIGINT, GG_ID BIGINT, TG_CODIGO BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE GRUPO ADD CONSTRAINT UNQ_GRUPO_0 UNIQUE (TG_Codigo, Curso, Letra)

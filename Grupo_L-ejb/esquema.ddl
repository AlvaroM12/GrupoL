CREATE TABLE USUARIO (ID BIGINT NOT NULL, DTYPE VARCHAR(31), EMAIL_INSTITUCIONAL VARCHAR, TELEFONO BIGINT, CONTRASEÑA VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE ALUMNO (ID BIGINT NOT NULL, APELLIDO1 VARCHAR, APELLIDO2 VARCHAR, CP BIGINT, DNI VARCHAR UNIQUE, DIRECCION VARCHAR, EMAIL_PERSONAL VARCHAR, LOCALIDAD VARCHAR, MÓVIL BIGINT, NOMBRE VARCHAR, PROVINCIA VARCHAR, PRIMARY KEY (ID))

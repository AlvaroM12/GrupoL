...
CREATE TABLE ENCUESTA (FECHA_DE_ENVIO BIGINT NOT NULL, EE_NUM_EXPEDIENTE BIGINT NOT NULL, PRIMARY KEY (FECHA_DE_ENVIO, EE_NUM_EXPEDIENTE))
...
CREATE TABLE MATRICULA (CURSO_ACADEMICO VARCHAR NOT NULL, ESTADO VARCHAR, FECHA_DE_MATRÍCULA DATE, NUEVO_INGRESO VARCHAR, NUM_ARCHIVO BIGINT, TURNO_PREFERENTE VARCHAR, EM BIGINT NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EM))
...
CREATE TABLE GRUPOSPORASIGNATURA_ENCUESTA (FECHA_DE_ENVIO BIGINT NOT NULL, EE_NUM_EXPEDIENTE BIGINT NOT NULL, CURSO_ACADEMICO BIGINT NOT NULL, G_GPA_ID BIGINT NOT NULL, A_GPA_REFERENCIA BIGINT NOT NULL, PRIMARY KEY (FECHA_DE_ENVIO, EE_NUM_EXPEDIENTE, CURSO_ACADEMICO, G_GPA_ID, A_GPA_REFERENCIA))
...
ALTER TABLE ASIGNATURAS_MATRÍCULA ADD CONSTRAINT FK_ASIGNATURAS_MATRÍCULA_Curso_Academico FOREIGN KEY (Curso_Academico, EM) REFERENCES MATRICULA (CURSO_ACADEMICO, EM)
